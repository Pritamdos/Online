                                ...
                                <div class="od-iner">
                                    ...
                                    <div class="s-stepper-content">
                                                ...
                                                <div class="stepper-form-inner-sec">
                                                    ...
                                                    <div class="stp-otr">
                                                            <div class="stp-left">
                                                                    ...
                                                                    <div class="each-rows-inputs">
                                                                        <span class="sb-tt">Number of pages/words you require</span>
                                                                        <div class="et-s">
                                                            ...
                                                            <div class="stp-right">
                                                                    <div class="each-rows-inputs">
                                                                            <input type="email" placeholder="Subject you are pursuing" />
                                                                            <span class="users-pp">
                                                                            <i class="fa fa-file" aria-hidden="true"></i>
                                                                    ...
                                                                    <div class="each-rows-inputs">
                                                                        <span class="sb-tt">Time Zone</span>
                                                                        <div class="et-s">
                                                                            <input type="time" placeholder="Enter your email id" />
                                                                            <span class="users-pp">
                                            ...
                                            <div id="stage2" class="s-stepper-stage">
                                                ...
                                                <div class="submit-button-sections-stepper">
                                                    <button class="done-btn-sections done">Done</button>
                                                </div>
                                            </div>
                                    </div>
                                </div>
